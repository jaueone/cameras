...
typedef struct _MV_GIGE_DEVICE_INFO_
{
    ...
    unsigned int        nNetExport;         // ch:网口IP地址 | en:NetWork IP Address
...
{
    int64_t         nReceiveDataSize;    // ch:已接收数据大小  [统计StartGrabbing和StopGrabbing之间的数据量] | en:Received Data Size  [Calculate the Data Size between StartGrabbing and StopGrabbing]
